...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-elixir/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-elixir/actions/workflows/validate.yml)

Neovim tree-sitter queries for **elixir**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-elixir",
...
- [ ] Changes are scoped to `elixir` — do not include files for other languages
